    ...
    public class cls_Tipo_Articulo_BLL
    {
        ...
        public bool Listar_Estados_SP(ref DataTable dt_Estados, ref string sMensajeError)
        {
            try
            {
                ...
                dt_Estados = DataSet.Tables["dt_Tipo_Articulo"];
        ...
        public void Insertar_Estados_SP(ref cls_TipoArticulo_DAL Obj_Cls_Tipo_Articulo_DAL, ref string sMensajeError)
        {
            try
            {
                #region Prepara cmd
        ...
        public void ModificarEstados_SP(ref cls_TipoArticulo_DAL Obj_Cls_Tipo_Articulo_DAL, ref string sMensajeError)
        {
            try
            {
                #region Prepara cmd
        ...
        public void EliminarEstados_SP(ref cls_TipoArticulo_DAL Obj_Cls_Tipo_Articulo_DAL, ref string sMensajeError)
        {
            try
            {
                #region Prepara cmd
