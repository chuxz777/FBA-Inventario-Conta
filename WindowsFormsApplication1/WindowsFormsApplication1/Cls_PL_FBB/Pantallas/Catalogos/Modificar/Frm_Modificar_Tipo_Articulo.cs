...
namespace Cls_PL.Pantallas.Catalogos.Modificar
{
    public partial class Frm_Modificar_Tipo_Articulo : Form
    {
        ...
        {
            Obj_Cls_Tipo_Articulo_BLL.Insertar_Estados_SP(ref Obj_Cls_Tipo_Articulo_DAL, ref sMensajeError);
        ...
        {
            Obj_Cls_Tipo_Articulo_BLL.ModificarEstados_SP(ref Obj_Cls_Tipo_Articulo_DAL, ref sMensajeError);
